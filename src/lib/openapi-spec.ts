...
export const API_ROUTE_REGISTRY: OpenApiRoute[] = [
  ...
  { method: 'post', path: '/api/client-portal/disputes/{id}/send', summary: 'Mail an approved dispute via Lob and start the FCRA § 611 30-day clock', tags: ['Client Portal'], security: true },
