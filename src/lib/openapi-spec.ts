...
export const API_ROUTE_REGISTRY: OpenApiRoute[] = [
  ...
  { method: 'post', path: '/api/client-portal/disputes/{id}/send', summary: 'Mail an approved dispute via Lob (postage wallet required) and start the FCRA § 611 30-day clock', tags: ['Client Portal'], security: true },
  { method: 'get', path: '/api/integrations/lob/status', summary: 'Lob mail connection status', tags: ['Integrations'], security: true },
  { method: 'post', path: '/api/integrations/lob/verify-address', summary: 'Verify a US mailing address via Lob', tags: ['Integrations'], security: true },
  { method: 'get', path: '/api/mail-postage/catalog', summary: 'Postage rates and credit packs', tags: ['Mail Postage'], security: true },
  { method: 'post', path: '/api/mail-postage/org/add-card', summary: 'Self-serve Stripe Checkout setup — firm adds card to unlock mailing', tags: ['Mail Postage'], security: true },
  { method: 'get', path: '/api/mail-postage/org', summary: 'Org postage wallet balance, card unlock status, and packs', tags: ['Mail Postage'], security: true },
  { method: 'post', path: '/api/mail-postage/org/credits/purchase', summary: 'Stripe Checkout for org postage pack (firm card)', tags: ['Mail Postage'], security: true },
  { method: 'put', path: '/api/mail-postage/org/settings', summary: 'Set who pays postage (org/client/cascade)', tags: ['Mail Postage'], security: true },
  { method: 'get', path: '/api/mail-postage/client', summary: 'Client postage wallet', tags: ['Mail Postage'], security: true },
  { method: 'post', path: '/api/mail-postage/client/credits/purchase', summary: 'Stripe Checkout for client postage pack', tags: ['Mail Postage'], security: true },
  { method: 'post', path: '/api/mail-postage/client/pay-letter', summary: 'Stripe Checkout for one letter postage', tags: ['Mail Postage'], security: true },
  ...
  { method: 'get', path: '/api/integrations/click2mail/addresses', summary: 'Legacy Click2Mail sender addresses (replaced by Lob)', tags: ['Integrations'], security: true },
  ...
  { method: 'get', path: '/api/public/tenant-by-host', summary: 'Resolve tenant by subdomain or custom domain (SPA boot)', tags: ['Settings'] },
  { method: 'get', path: '/api/admin/tenants/subdomain-check', summary: 'Check subdomain availability (platform owner)', tags: ['Admin'], security: true },
  { method: 'post', path: '/api/admin/tenants/provision', summary: 'CREATE BUSINESS — one-click tenant provisioning', tags: ['Admin'], security: true },
  { method: 'post', path: '/api/admin/tenants/{targetOrgId}/clone-config', summary: 'Clone tenant branding/workflows (no secrets/data)', tags: ['Admin'], security: true },
  { method: 'get', path: '/api/oauth/{provider}/callback', summary: 'Central OAuth callback hub with tenant redirect', tags: ['Integrations'] },
  ...
  { method: 'post', path: '/api/webhooks/ghl', summary: 'Inbound GHL webhook (DNC/consent sync)', tags: ['Integrations'] },
  { method: 'get', path: '/api/clients/{id}/timeline', summary: 'Unified client timeline (staff)', tags: ['Compliance OS'], security: true },
  { method: 'get', path: '/api/clients/{id}/communication-preferences', summary: 'Client communication preferences (staff)', tags: ['Compliance OS'], security: true },
  { method: 'put', path: '/api/clients/{id}/communication-preferences', summary: 'Update client communication preferences (staff)', tags: ['Compliance OS'], security: true },
  { method: 'get', path: '/api/client-portal/timeline', summary: 'Client portal activity timeline', tags: ['Compliance OS'], security: true },
  { method: 'get', path: '/api/client-portal/communication-preferences', summary: 'Client portal preference center', tags: ['Compliance OS'], security: true },
  { method: 'put', path: '/api/client-portal/communication-preferences', summary: 'Update client portal preferences', tags: ['Compliance OS'], security: true },
  { method: 'post', path: '/api/client-portal/push/subscribe', summary: 'Register web push subscription', tags: ['Compliance OS'], security: true },
  { method: 'get', path: '/api/compliance-os/automation-catalog', summary: 'Automation trigger and step type catalog', tags: ['Compliance OS'], security: true },
  { method: 'get', path: '/api/compliance-os/automations', summary: 'List custom automations', tags: ['Compliance OS'], security: true },
  { method: 'post', path: '/api/compliance-os/automations', summary: 'Create custom automation draft', tags: ['Compliance OS'], security: true },
  { method: 'post', path: '/api/compliance-os/automations/{id}/activate', summary: 'Activate approved automation', tags: ['Compliance OS'], security: true },
  { method: 'post', path: '/api/compliance-os/automations/{id}/run', summary: 'Manually run automation for client/lead', tags: ['Compliance OS'], security: true },
  { method: 'get', path: '/api/campaigns/{id}/approval', summary: 'Campaign approval status and audit log', tags: ['Campaigns'], security: true },
